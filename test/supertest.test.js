...
describe("test products", () => {
  ...
  it("El endpoint GET /api/dbProducts muestra todos los productos", async () => {
  ...
  it("El endpoint POST /api/dbProducts agrega producto a la base de datos", async () => {
    const randomProduct = {
...
describe("test cart", () => {
  it("El endpoint GET /api/dbCarts/:cid obtiene un carrito", async () => {
  ...
  it("El endpoint POST /api/dbCarts/cartId/:productId agrega un producto a un carrito", async () => {
  ...
  it("El endpoint PUT /api/dbCarts/:cid/products/:pid actualiza solo la cantidad de unidades de un producto del carrito", async () => {
    const newQuantity = {
      quantity: 5,
    };
  ...
  it("El endpoin POST /api/dbCarts/:cid/products/:pid elimina un producto del carrito", async () => {
  ...
  it("El enpoint DELETE /api/dbCarts/:cid elimina todos los productos del carrito", async () => {
